...
func (c *consumerLimitServiceClient) GetConsumerLimitsByConsumerId(ctx context.Context, in *ConsumerRequest, opts ...grpc.CallOption) (*ConsumerLimitListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xyz_grpc.ConsumerLimitService/GetConsumerLimitsByConsumerId", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *consumerLimitServiceClient) CreateConsumerLimit(ctx context.Context, in *ConsumerLimit, opts ...grpc.CallOption) (*ConsumerLimitResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xyz_grpc.ConsumerLimitService/CreateConsumerLimit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *consumerLimitServiceClient) UpdateAvailableLimit(ctx context.Context, in *UpdateAvailableLimitRequest, opts ...grpc.CallOption) (*ConsumerLimitResponse, error) {
	out := new(ConsumerLimitResponse)
	err := c.cc.Invoke(ctx, "/xyz_grpc.ConsumerLimitService/UpdateAvailableLimit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *consumerLimitServiceClient) GetConsumerLimitByConsumerIdAndTenor(ctx context.Context, in *ConsumerIdAndTenorRequest, opts ...grpc.CallOption) (*ConsumerLimitResponse, error) {
	out := new(ConsumerLimitResponse)
	err := c.cc.Invoke(ctx, "/xyz_grpc.ConsumerLimitService/GetConsumerLimitByConsumerIdAndTenor", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ConsumerLimitService_GetConsumerLimitsByConsumerId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xyz_grpc.ConsumerLimitService/GetConsumerLimitsByConsumerId",
	}
...
func _ConsumerLimitService_CreateConsumerLimit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xyz_grpc.ConsumerLimitService/CreateConsumerLimit",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ConsumerLimitService_UpdateAvailableLimit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xyz_grpc.ConsumerLimitService/UpdateAvailableLimit",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ConsumerLimitService_GetConsumerLimitByConsumerIdAndTenor_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xyz_grpc.ConsumerLimitService/GetConsumerLimitByConsumerIdAndTenor",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
