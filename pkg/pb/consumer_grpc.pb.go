...
func (c *consumerServiceClient) GetAllConsumers(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ConsumerListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xyz_grpc.ConsumerService/GetAllConsumers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *consumerServiceClient) GetConsumerById(ctx context.Context, in *ConsumerIdRequest, opts ...grpc.CallOption) (*ConsumerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xyz_grpc.ConsumerService/GetConsumerById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *consumerServiceClient) CreateConsumer(ctx context.Context, in *ConsumerDataRequest, opts ...grpc.CallOption) (*ConsumerResponse, error) {
	out := new(ConsumerResponse)
	err := c.cc.Invoke(ctx, "/xyz_grpc.ConsumerService/CreateConsumer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *consumerServiceClient) UpdateConsumer(ctx context.Context, in *ConsumerDataRequest, opts ...grpc.CallOption) (*ConsumerResponse, error) {
	out := new(ConsumerResponse)
	err := c.cc.Invoke(ctx, "/xyz_grpc.ConsumerService/UpdateConsumer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *consumerServiceClient) DeleteConsumer(ctx context.Context, in *ConsumerIdRequest, opts ...grpc.CallOption) (*ConsumerResponse, error) {
	out := new(ConsumerResponse)
	err := c.cc.Invoke(ctx, "/xyz_grpc.ConsumerService/DeleteConsumer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ConsumerService_GetAllConsumers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xyz_grpc.ConsumerService/GetAllConsumers",
	}
...
func _ConsumerService_GetConsumerById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xyz_grpc.ConsumerService/GetConsumerById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ConsumerService_CreateConsumer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xyz_grpc.ConsumerService/CreateConsumer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ConsumerService_UpdateConsumer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xyz_grpc.ConsumerService/UpdateConsumer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ConsumerService_DeleteConsumer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xyz_grpc.ConsumerService/DeleteConsumer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
