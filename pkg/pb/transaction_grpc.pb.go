...
func (c *transactionServiceClient) GetAllTransactions(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*TransactionListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xyz_grpc.TransactionService/GetAllTransactions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transactionServiceClient) GetTransactionsByConsumerId(ctx context.Context, in *TransactionConsumerIdRequest, opts ...grpc.CallOption) (*TransactionListResponse, error) {
	out := new(TransactionListResponse)
	err := c.cc.Invoke(ctx, "/xyz_grpc.TransactionService/GetTransactionsByConsumerId", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transactionServiceClient) GetTransactionByContractNumber(ctx context.Context, in *TransactionContractNumberRequest, opts ...grpc.CallOption) (*TransactionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xyz_grpc.TransactionService/GetTransactionByContractNumber", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transactionServiceClient) CreateTransaction(ctx context.Context, in *Transaction, opts ...grpc.CallOption) (*TransactionResponse, error) {
	out := new(TransactionResponse)
	err := c.cc.Invoke(ctx, "/xyz_grpc.TransactionService/CreateTransaction", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TransactionService_GetAllTransactions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xyz_grpc.TransactionService/GetAllTransactions",
	}
...
func _TransactionService_GetTransactionsByConsumerId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xyz_grpc.TransactionService/GetTransactionsByConsumerId",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TransactionService_GetTransactionByContractNumber_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xyz_grpc.TransactionService/GetTransactionByContractNumber",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TransactionService_CreateTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xyz_grpc.TransactionService/CreateTransaction",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
